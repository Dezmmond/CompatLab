...
Сейчас репозиторий содержит первый чистый каркас проекта. Команды возвращают
структурированные stub-отчеты, а реальный backend на `readelf` и правила
сравнения будут добавлены на следующих этапах.
